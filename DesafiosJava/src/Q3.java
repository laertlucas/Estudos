...
public class Q3 {
	public static void main(String[] args) {
		...
		if ((n1 < n2) && (n1 < n3)) {
			JOptionPane.showMessageDialog(null,"O menor número é o " + n1);
		} else if ((n2 < n1) && (n2 < n3)) {
			JOptionPane.showMessageDialog(null,"O menor número é o " + n2);
		} else {
		
		JOptionPane.showMessageDialog(null,"O menor número é o " + n3);
		}
		
}
}

/* Escreva um programa para calcular o maior e o menor de três números
inteiros.
*/